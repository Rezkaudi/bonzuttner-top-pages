        ...
        <section className="min-h-screen bg-gradient-to-b-from-transparent relative" id="story">
            <Container className="pt-24">
                ...
                <div className="mt-16 flex items-center justify-center w-full ">
                    <div className="max-w-[900px] w-[900px] h-[480px]">
                        <Swiper
                            ...
                            {stories.map(item =>
                                <SwiperSlide key={item.id}>
                                    <div className="w-full h-full flex items-center justify-start flex-col lg:flex-row">
                                        <div className="flex flex-col h-[430px] items-start px-12 py-14 mr-0 bg-white w-full">
                                            ...
                                            <Button className="mt-10 bg-[#00A1E9] text-white font-medium text-sm p-3 rounded-lg">
                                                READ MORE
                                            </Button>
                                        </div>
                                        <div className="lg:right lg:absolute lg:right-7 lg:top-0 lg:w-[400px] lg:h-[480px] z-10 inline">
